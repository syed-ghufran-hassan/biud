...
# Update page.tsx with wooden theme - multiple commits
...
EOF
git add -A && git commit -m "refactor(page): start wooden theme migration"
...
EOF
git add -A && git commit -m "feat(page): add FloatingCat to header"
...
EOF
git add -A && git commit -m "feat(page): add hero section with wooden theme"
...
EOF
git add -A && git commit -m "feat(page): add name search with wooden styling"
